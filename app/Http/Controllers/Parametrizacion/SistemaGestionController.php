...
class SistemaGestionController extends Controller
{
    ...
    public function index(Request $request)
    {
    	if ($request) {
    		...
    		return view('pages.parametrizacion.sistema_gestion',['proceso'=>$proceso,'tabla_sisgestion'=>$tabla_sisgestion,'tabla_procesos_sisgestion'=>$tabla_procesos_sisgestion]);
    	}
    }
