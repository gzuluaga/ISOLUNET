...
<div class="br-pagebody">
  <div class="br-section-wrapper">	
  	 <div class="row">
		...
		<br>
		{{  Form::open(['action' => 'Parametrizacion\ProcesosController@store_apoyo','autocomplete'=>'off', 'method' => 'POST', 'files' => true]) }}
		{!! Form::token() !!}

		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
				<div class="form-group">
			    	<input type="text" name="cod_proceso" class="form-control" required value="Procesos de Apoyo" readonly>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
				<div class="form-group">
...
<div class="br-section-wrapper">
			<div class="row">
				<h4>Listado de procesos de Apoyo</h4>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td>{{ $pa->nom_proceso }}</td>
									<td>{{ $pa->sigla }}</td>
									<td>{{ $pa->name }}</td>
									<td>{{ $pa->descripcion }}</td>
									<td>{{ $pa->name.' '.$pa->fk_usuario_responsable}}</td>
									<td colspan="2">
										<a href="{{ URL::action('Parametrizacion\ProcesosController@edit_proceso_apoyo',$pa->id_proceso) }}""><i class="fas fa-pencil-alt fa-2x" style="color:#18A4B4;"></i></a>
										<a href="{{ URL::action('Parametrizacion\ProcesosController@destroy_proceso_apoyo',$pa->id_proceso) }}" ><i class="fas fa-trash-alt fa-2x" style="color:#C10000;"></i></a>
									</td>																
								</tr>
								@endforeach
							</tbody>
