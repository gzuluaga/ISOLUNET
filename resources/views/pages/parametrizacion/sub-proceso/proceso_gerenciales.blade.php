...
<div class="br-pagebody">
	<div class="br-section-wrapper">	
		...
		<br>
		{{  Form::open(['action' => 'Parametrizacion\ProcesosController@store_gerenciales','autocomplete'=>'off', 'method' => 'POST', 'files' => true]) }}
		{!! Form::token() !!}

		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
				<div class="form-group">
			    	<input type="text" name="cod_proceso" class="form-control" required value="Procesos Gerenciales" readonly>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
				<div class="form-group">
		...
		<div class="br-section-wrapper">
			<div class="row">
				<h4>Listado de Procesos Gerenciales</h4>
			</div>
			<div class="row">
