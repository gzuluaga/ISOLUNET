...
<div class="br-pageheader">
	<nav class="breadcrumb pd-0 mg-0 tx-12">
	  ...
	  <span class="breadcrumb-item active">Editar Proceso Misional</span>
	</nav>
</div><!-- br-pageheader -->
...
<div class="br-pagetitle">
	...
	<div>
  		<h4>Administración de Procesos Misionales</h4>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">	
		...
		<br>
		{{  Form::open(['action' => ['Parametrizacion\ProcesosController@update_proceso_misional',$proceso->id_proceso],'autocomplete'=>'off', 'method' => 'POST', 'files' => true]) }}
		{!! Form::token() !!}
